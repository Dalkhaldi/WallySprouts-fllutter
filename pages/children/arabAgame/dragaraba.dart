...
import 'package:wallysprouts/pages/children/arabAgame/wordsaraba.dart';
import 'dart:math';
import 'package:wallysprouts/pages/children/pagecoicearabic.dart';
//Add Arabic
class GamearabMatching extends StatefulWidget {
  @override
  _GamearabMatchingState createState() => _GamearabMatchingState();
}

class _GamearabMatchingState extends State<GamearabMatching> {
...
Future saveScore(int score, int time_now1) async {
  ...
  initGame() {
    ...
    score = 0;
    item1 = [
      ItemAnimal(image: " أ",  name: "أرنب", value: "أرنب", color:Colors.orange.shade300),
      ItemAnimal(image: "ب", name: "باب", value: "باب",color:Colors.teal.shade300),
      ItemAnimal(image: " ت", name: "تلفاز", value: "تلفاز",color:Colors.purple.shade300),
      ItemAnimal(image: "ث", name: "ثمار", value: "ثمار",color:Colors.redAccent),
      ItemAnimal(image: "ج", name: "جامع", value: "جامع", color:Colors.orange.shade300),
      ItemAnimal(image: "ح", name: "حساب", value: "حساب",color:Colors.teal.shade300),
      ItemAnimal(image: "خ", name: "خباز", value: "خباز",color:Colors.purple.shade300),
      ItemAnimal(image:"د", name: "دخان", value: "دخان",color:Colors.redAccent),
    ];
     /*item1 = [
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.of(context).push(MaterialPageRoute(
                               builder: (context){
                                   return arabMathcing();//CanvasPainting();//GameDDAnimaleMatching();
                               }));
        },
      ),
                          ...
                          if (item.value == receivedItem.value) {
                            setState(() {
                              ...
                              setState(() {
                                if (item.value == "أرنب") {
                                  _speakAR("أرنب");
                                } else if (item.value == "ثمار") {
                                  _speakAR("ثمار");
                                } else if (item.value == "تلفاز") {
                                  _speakAR("تلفاز");
                                } else if (item.value == "جامع") {
                                  _speakAR("جامع");
                                }   else if (item.value == "حساب") {
                                  _speakAR("حساب");
                                } else if (item.value == "خباز") {
                                  _speakAR("خَبّاز");
                                } else if (item.value == "دخان") {
                                  _speakAR("دُخان");
                                } else if (item.value == "باب") {
                                  _speakAR("ُباب");
                                }
                              });
...
class ItemAnimal {
  ...
  ItemAnimal({this.name, this.value,this.image, this.icon,this.color, this.accepting = false});
}
