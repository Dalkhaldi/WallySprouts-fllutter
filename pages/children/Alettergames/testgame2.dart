...
//Done All ********************************
class GamesubMathcing extends StatefulWidget {
  @override
  _GamesubMathcingState createState() => _GamesubMathcingState();
}

class _GamesubMathcingState extends State<GamesubMathcing> {
...
String animationType = "idle";
  ...
  initGame() {
    ...
    score = 0;
    item1 = [
      ItemAnimal(eq: result0[rng.nextInt(12)], name: "A", value: " A ", color:Colors.orange.shade300),
      ItemAnimal(eq: result3[rng.nextInt(12)], name: "a", value: " a ",color:Colors.teal.shade300),
