...
class CanvasPaintingarab extends StatefulWidget {
  @override
  _CanvasPaintingarabState createState() => _CanvasPaintingarabState();
}

class _CanvasPaintingarabState extends State<CanvasPaintingarab> {
          ...
          child: RepaintBoundary(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Center(
                  child:_image==null?Image.asset("assets/Awrite.png"):Container(
                    height: 300,
                    width: 300,
                   // child: /*Image.asset(_image==null?"assets/Awrite.jpg":*/FileImage(File(_image.path)),
               constraints: BoxConstraints.expand(),
        decoration: BoxDecoration(
          image:DecorationImage(
             image:_image==null?AssetImage("assets/Awrite.png"):FileImage(File(_image.path)),
             fit:BoxFit.cover
          ),
        ),
                  )
