...
class CanvasPaintingb extends StatefulWidget {
  @override
  _CanvasPaintingbState createState() => _CanvasPaintingbState();
}

class _CanvasPaintingbState extends State<CanvasPaintingb> {
        ...
        body: GestureDetector(
          ...
          child: RepaintBoundary(
            ...
            child: Stack(
              children: <Widget>[
                Center(
                  child: Image.asset("assets/bigB.jpg"),
                ),
                CustomPaint(
                  size: Size.infinite,
                  painter: MyPainter(
