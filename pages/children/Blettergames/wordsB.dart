...
import 'package:wallysprouts/pages/children/Blettergames/dragB.dart';
 

 

class DragwordsB extends StatelessWidget {
...
class _DragPicturewordsState extends State<DragPicturewords> {
  ...
  void initState() {
   ...
   List<Item> itemlist = [
  Item(name: "1", address: "assets/BL.svg",voice:"kid-b.mp3"),
  Item(name: "2", address: "assets/a (2).svg",voice:"kid-a.mp3"),
  Item(name: "3", address: "assets/sl.svg",voice:"kid-s.mp3"),
  Item(name: "4", address: "assets/e.svg",voice:"kid-e.mp3"),
  Item(name: "5", address: "assets/bl (2).svg",voice:"kid-b.mp3"),
  Item(name: "6", address: "assets/a (2).svg",voice:"kid-a.mp3"),
  Item(name: "7", address: "assets/l.svg",voice:"kid-l.mp3"),
  Item(name: "8", address: "assets/l.svg",voice:"kid-l.mp3"),
  ...
  List<bool> _isDone = [false, false, false,false,false,false,false,false];
  List<bool> elementState = [false, false, false,false,false,false,false,false];
  double itemsize = 40;
  double newsize = 30;
  @override
  Widget build(BuildContext context) {
