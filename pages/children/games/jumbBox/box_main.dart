...
import 'package:wallysprouts/pages/children/games/jumbBox/settings.dart';
//import './settings/game-setting.dart';

import 'package:wallysprouts/pages/children/games/jumbBox/player.dart';
import 'package:wallysprouts/pages/children/games/jumbBox/obstacle.dart';
            ...
            child: TapFadeText(
              child: FlatButton(
                onPressed: () async {
                  ...
                  _audioPlayer = await _audioCache.play('main-game.mp3');
                },
                child: Text(
