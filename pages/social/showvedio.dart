...
class VideoAppsocial extends StatefulWidget {
  final String videopath;
  VideoAppsocial(this.videopath);
  @override
  _VideoAppsocialState createState() => _VideoAppsocialState(videopath);
}

class _VideoAppsocialState extends State<VideoAppsocial> {
  String videopath;
  _VideoAppsocialState(this.videopath);
 ...
 /* @override
  ...
  {
    _controller = VideoPlayerController.network(
        'http://192.168.1.8:8081/WallySprouts/upload/$videopath')
      ..initialize().then((_) {
